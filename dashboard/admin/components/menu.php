<aside style="background: <?php echo $_SESSION['asideColor'] ;?>;" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
	...
	<div style="    height: calc(100vh - 200px);" class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link  <?php echo ($active == 'new') ? "active"  : ""; ?>" href="./nuevo_miembro.php">
					<div style=<?php echo "'background-image:$principalColor;'"?>
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
						<i class="fa-solid fa-user-plus opacity-10" ></i>
					</div>
					<span class="nav-link-text ms-1">Nuevo Miembro</span>
				</a>
			</li>
			
			<li class="nav-item">
				<a class="nav-link  <?php echo ($active == 'memberships') ? "active"  : ""; ?>" href="./membresias.php">
					<div style=<?php echo "'background-image:$principalColor;'"?>
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
