<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link  <?php echo ($active == 'dashboard') ? "active"  : ""; ?>" href="./index.php">
						<div
							style=<?php echo "'background-image:$principalColor;'"?> class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
		...
		<div class="sidenav-footer mx-3 ">
			<button style=<?php echo "'background-image:$principalColor;'"?> data-bs-toggle="modal" data-bs-target="#modalRegisterVisit" class="btn bg-gradient-primary mt-3 w-100">Registrar Visita</button>
		</div>
