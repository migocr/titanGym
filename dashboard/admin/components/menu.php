<aside style="background: <?php echo $_SESSION['asideColor'] ;?>;" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
	...
	<div class="sidenav-header">
		<i class="fas fa-times p-1 cursor-pointer text-secondary opacity-10 position-absolute end-0 top-0 d-none d-xl-none"
			aria-hidden="true" id="iconSidenav"></i>
		<a class="navbar-brand m-0 d-block" href=" ./ " style="    margin: 0px 10px!important;     padding: 1em 0em;
}">
			<img src="../assets/img/logo.jpg" class="navbar-brand-img h-100 w-100" style="max-height: 100%;
    padding: 6px 1em;
    background: white;
    border-radius: 10px;" alt="main_logo">
	...
	<div style="    height: calc(100vh - 200px);" class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item miembros" >
				...
				<div class="collapse  <?php echo ($active == 'members'  || $active == 'new'  || $active == 'member-list') ? "show"  : ""; ?>" id="pagesExamples" style="">
				<ul class="nav ms-4 ps-3 px-2 py-2">
					<li class="nav-item submenu my-1 <?php echo ($active == 'member-list') ? "active"  : ""; ?>" >
						<a class="nav-link " href="./members.php" style="margin: 0 10px 0 0; border-radius: 5px;">
							<span class="sidenav-mini-icon"> P </span>
							<span class="sidenav-normal"><i style="padding-right: 5px;" class="fa-solid fa-list pr-2"></i> Lista de miembros</span>
						</a>
					</li>
			...
			<li class="nav-item" >
				...
				<div class="collapse  <?php echo ($active == 'memberships'  || $active == 'new_membership') ? "show"  : ""; ?>" id="memberships" style="">
				<ul class="nav ms-4 ps-3 px-2 py-2">
					<li class="nav-item submenu my-1 <?php echo ($active == 'memberships') ? "active"  : ""; ?>" >
						<a class="nav-link " href="./membresias.php" style="margin: 0 10px 0 0; border-radius: 5px;">
							<span class="sidenav-mini-icon"> P </span>
							<span class="sidenav-normal"><i style="padding-right: 5px;" class="fa-solid fa-list pr-2"></i> Lista de membresias</span>
						</a>
					</li>
